...
(remove-hook 'org-mode 'helm-gtags-mode)

;;;;;;;;;;;;;;;;;;;;; ORG - SYNC ;;;;;;;;;;;;;;;;;;;
;;
;; (add-to-list 'load-path "~/.emacs.d/external/org-sync")
;;  (mapc 'load
;;        '("org-element" "os" "os-rmine"))
;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;; (setq org-clock-clocktable-default-properties
;;       (quote
;;        (:maxlevel 10 :scope agenda :block lastweek :formula % :narrow 80 :emphasize t :compact t :ident t)))
...
;;;; Clocking work time
;; For save the clock history across Emacs sessions
...
;;         work-minutes
;;         overtime-minutes)
;;     (decfonst minutes-in-a-workday 480)
...
;;;;;;;;;;
;;    Org capture config http://doc.norang.ca/org-mode.html#CaptureTemplates
;; Capture templates for: TODO tasks, Notes, appointments, phone calls, meetings, and org-protocol
;; Capture mode now handles automatically clocking in and out of a capture task.
;; This all works out of the box now without special hooks. When I start a capture mode task
;; the task is clocked in as specified by :clock-in t and
;; when the task is filed with C-c C-c the clock resumes on the original clocking task.
;;;;;;;
(setq org-capture-templates
      (quote (("t" "todo" entry (file org-default-notes-file)
              ...
              ("n" "note" entry (file org-default-notes-file)
               "* %? :NOTE:\n%U\n%a\n" :clock-in t :clock-resume t)
              ("j" "Journal" entry (file+datetree org-defailt-datetree-file)
               "* %?\n%U\n" :clock-in t :clock-resume t)
              ("J" "Journal" entry (file+datetree+prompt org-defailt-datetree-file)
               "* %?\n%U\n" :clock-in t :clock-resume t)
...
;; Настройка поведения при открытии ссылок
...
(use-package org-mru-clock
  :bind (("C-c C-x C-i"		. org-mru-clock-in)
